...
public protocol SettingTextFieldGroupSectionDelegate: class {
    func settingTextFieldGroup(_ setting: Setting.TextField, didChangeToNewText text: String)
}

extension Setting {
    internal class TextFieldGroupSection: Setting.BaseGroupSection, SettingTextFieldCellDelegate, ListBindingSectionControllerSelectionDelegate, ListBindingSectionControllerDataSource {
        ...
        internal weak var delegate: SettingTextFieldGroupSectionDelegate?
        // ====================
