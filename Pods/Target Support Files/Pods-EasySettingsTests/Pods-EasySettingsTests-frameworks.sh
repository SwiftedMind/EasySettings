...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AdvancedSegmentedControl/AdvancedSegmentedControl.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwipeCell/SwipeCell.framework"
